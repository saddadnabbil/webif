...
class Admin_informasi extends CI_Controller {
    ...
    {   
        ...
        // Config
        $config['base_url'] = 'https://webif.selfloveid.xyz/admin_informasi/index';
        ...
        $this->load->view('templates/admin_detail_informasi_header', $data, $coba);
        $this->load->view('admin_informasi/index', $data);
    ...
    public function tambah() 
    {
        ...
        if( $this->form_validation->run() == FALSE ) {
            $this->load->view('templates/admin_detail_informasi_header', $data, $data);
            $this->load->view('admin_informasi/tambah', $data);
            $this->load->view('templates/footer');
        } else {
    ...
    public function detail($id)
    {
        ...
        $data['informasi'] = $this->Informasi_model->getInformasiById($id);
            ...
            $this->load->view('templates/admin_detail_informasi_header', $data);
           $this->load->view('admin_informasi/detail', $data);
           $this->load->view('templates/footer');
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
        $this->load->view('templates/admin_detail_informasi_header', $data);
        $this->load->view('admin_informasi/edit', $data);
        $this->load->view('templates/footer');
        }  else {
