...
class Mahasiswa extends CI_Controller {
    ...
    {   
        ...
        // Config
        $config['base_url'] = 'https://webif.selfloveid.xyz/mahasiswa/index';
        ...
        $this->load->view('templates/admin_header', $coba, $coba);
    ...
    public function tambah() 
    {
        ...
        if( $this->form_validation->run() == FALSE ) {
            $this->load->view('templates/admin_header', $data, $data);
    ...
    public function detail($id)
    {
        ...
        $this->load->view('templates/admin_profile_header', $coba, $data);
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
        $this->load->view('templates/admin_header', $coba, $data);
