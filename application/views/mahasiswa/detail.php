                ...
                <div class="text-center mt-3"> <button class=" btn btn-secondary p-1 px-4 rounded text-white"  style="border: none;" >Active</button>
                    <h5 class="mt-2 mb-0"><?= $user['name']; ?></h5> <span><?= $user['nim']; ?></span>
                        <table class="table table-borderless">
                            ...
                            <tbody>
                            <tr>
                                <th scope="row"><small class=" "><b>Major</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </small></th>
                    ...
                    <div class="buttons "> 
                        <a href="<?= base_url(); ?>mahasiswa"><button class="btn btn-outline px-4 back ">Back</button></a>   
                        <a href="<?= base_url(); ?>mahasiswa/edit/<?= $user['id']; ?>" ><button class="btn btn-primary px-4 ms-3 edit align-items-center" >Edit</button></a> 
                    </div>
                </div>
            </div>
        </div>
