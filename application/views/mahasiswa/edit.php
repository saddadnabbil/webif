...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
            ...
            <div class="card outline-warning" style="background-color: white;">
                ...
                <div class="form-group row my-3">
                    <label for="tanggal_lahir" class="col-sm-2 col-form-label">Place & Date of Birth</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tanggal_lahir" name="tanggal_lahir" placeholder="ex: Cilegon, 17 augst 2003" value="<?= $user['tanggal_lahir']; ?>" >
                ...
                <div class="form-group row my-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="instagram" name="instagram" placeholder="ex: amorazl_ // don't use @ " value="<?= $user['instagram']; ?>" >
                ...
                <div class="form-group row my-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="twitter" name="twitter" placeholder="ex: amorazl_ // don't use @ " value="<?= $user['twitter']; ?>" >
                ...
                <div class="col-sm-10">
                        <button class="btn btn-primary" style=" background-color: #F6B459; color: white; border: 0px;"><a href="<?= base_url();?>mahasiswa" class="float-end mx-2" style=" background-color: #F6B459; color: white; text-decoration: none;">Back</a></button>
