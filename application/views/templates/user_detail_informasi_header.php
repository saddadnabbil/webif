...
<html lang="en">
  <head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/informasi/nicepage1.css">
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/informasi/Page1.css">
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/informasi/first/style.css">
  ...
  <div class="container my-5">
        <nav class="navbar navbar-expand-lg navbar-light  costume-nav bg-transparent ">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="<?= base_url(); ?>user">WEB<span>IF</span></a>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <div class="dropdown border-0 mx-2">
                            ...
                            <?= $user['name']; ?>
                                ...
                                <li><a class="dropdown-item" href="<?= base_url(); ?>user_profile">My Profile</a></li>
                                <li><a class="dropdown-item" href="<?= base_url(); ?>user/edit">Edit Profile</a></li>
                                <li><a class="dropdown-item" href="<?= base_url(); ?>user/changepassword">Change Password</a></li>
