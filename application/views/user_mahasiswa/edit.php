    ...
    <div class="row justify-content-center">
            ...
            <div class="card">
                ...
                <div class="form-group row justify-content-end">
                    <div class="col-sm-10">
                        <button class="btn btn-primary" style=" background-color: #F6B459; color: white; border: 0px;"><a href="<?= base_url();?>user_mahasiswa" class="float-end mx-2" style=" background-color: #F6B459; color: white; text-decoration: none;">Back</a></button>
                        <button type="submit" class="btn btn-primary " style=" background-color: #F6B459; color: white; border: 0px;">Edit</button>
                    </div>
                </div>
