        ...
        <div class="col-md-7">
            <div class="card p-8 py-4 px-5 ">
                ...
                <div class="text-center mt-3"> <button class=" btn btn-secondary p-1 px-4 rounded text-white"  style="border: none;" >Active</button>
                    ...
                    <div class="buttons "> 
                        <a href="<?= base_url(); ?>admin"><button class="btn btn-outline px-4 back ">Back</button></a>   
                        <a href="<?= base_url(); ?>admin/edit" ><button class="btn btn-primary px-4 ms-3 edit align-items-center" >Edit</button></a>  
                    </div>
                </div>
            </div>
        </div>
