            ...
            <div class="row justify-content-md-center">
                <div class="col-md-10">
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        Information  <?= $this->session->flashdata('flash'); ?> <strong>successfully</strong>.
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-9">
                <div class="d-flex justify-content-center">
                    <h3 style="font-size: 1.75rem; font-weight: 500;">Information Assignment</h3>
                </div>
                <div class="row height d-flex justify-content-center align-items-center">
                    <div class="col-md-13">
                    <a href="<?= base_url() ?>admin_informasi/tambah" class='btn btn-warning my-3' style="background-color: #F6B459; color: white;" >Add Information</a>
                        ...
                        <form action="" method="post">
                          <div class="input-group-append"> 
                              <div class="input-group mb-3"> 
                                <input type="text" class="form-control input-text btn-outline-warning"  style="background-color: white;" placeholder="Search information assigment (subject/assignment/deadline)" name="keyword">
        ...
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_description">
              ...
              <button type="button" class="read_more_btn float-end" ><a href="<?= base_url(); ?>admin_informasi/hapus/<?= $inf['id']; ?>" onclick="return confirm('Are you sure you want to delete the information <?= $inf['matkul']; ?>?');">Delete</a></button>
              <button type="button" class="read_more_btn float-end mx-2"><a href="<?= base_url(); ?>admin_informasi/edit/<?= $inf['id']; ?>">Edit</a></button>
              <button type="button" class="read_more_btn float-end "><a href="<?= base_url(); ?>admin_informasi/detail/<?= $inf['id']; ?>">Detail</a></button>
            </div>
          </div>
        <?php $i++; ?>   
        <?php endforeach; ?> 
