            ...
            <div class="card" style="background-color: white;">
                ...
                <div class="form-group row justify-content-end">
                    <div class="col-sm-10">
                        ...
                        <button type="submit" name="edit" class="btn btn-warning float-end mx-2" style=" background-color: #F6B459; color: white;" ><a href="<?= base_url();?>user_informasi" class="float-end mx-2" style=" background-color: #F6B459; color: white; text-decoration: none;">Kembali</a></button>
                    </div>
                </div>
